...
| 1    | Create a New Branch                         | https://github.com/dianetambey/ppchem/tree/myenv        |
...
| 4    | Update `env.yml` via a Pull Request         | https://github.com/`dianetambey`/practical-programming-in-chemistry-milestones/pull/`pull-request-number` |
